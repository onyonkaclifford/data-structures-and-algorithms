...
class DoublyLinkedList(LinkedList):
    ...
    def _insert_between(
        ...
        """Helper function to insert a node between two other nodes. Time complexity: O(1).
    ...
    def _remove_between(
        ...
        """Helper function to remove a node between two other nodes. Time complexity: O(1).
