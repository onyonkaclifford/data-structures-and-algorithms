...
class _Node(_BaseNode):
    def __init__(self, data, next_node: Union[_BaseNode, None] = None):
        super().__init__(next_node)
        self.data = data


class _SentinelNode(_BaseNode):
    def __init__(self, next_node: Union[_BaseNode, None] = None):
        super().__init__(next_node)


class CircularlySinglyLinkedList:
    def __init__(self):
        self.__head = _SentinelNode(_SentinelNode())
        self.__length = 0
        self.__current_node: Union[_Node, None] = None

        tail = self.__head.next_node
        tail.next_node = self.__head

    def __len__(self):
        """ Returns total number of items in list. Time complexity: O(1).

        >>> l_list = CircularlySinglyLinkedList()
        >>> len(l_list)
        0
        >>> l_list.append(1)
        >>> len(l_list)
    ...
    def __iter__(self):
        """ Returns a circularly singly linked list iterable. Time complexity: O(1).
        ...
        :return: circularly singly linked list iterable
        """
        return self

    def __next__(self):
        """ Returns next item of circularly singly linked list iterator. Time complexity: O(1).
    ...
    def __delitem__(self, idx: int):
        ...
        CircularlySinglyLinkedList._remove_between(previous_node, current_node.next_node)
    ...
    def _insert_between(new_node: _BaseNode, node1: _BaseNode, node2: _BaseNode):
        ...
        >>> node_1 = _Node(0, _Node(1))
        >>> isinstance(node_1.next_node.next_node, _Node)
        False
        >>> CircularlySinglyLinkedList._insert_between(_Node(2), node_1, node_1.next_node)
        >>> isinstance(node_1.next_node.next_node, _Node)
        True
        """
    ...
    def _remove_between(node1: _BaseNode, node2: _BaseNode):
        ...
        >>> node_1 = _Node(0, _Node(1, _Node(2)))
        >>> isinstance(node_1.next_node.next_node, _Node)
        True
        >>> CircularlySinglyLinkedList._remove_between(node_1, node_1.next_node.next_node)
        >>> isinstance(node_1.next_node.next_node, _Node)
        False
        """
    ...
    def insert(self, idx: int, data):
        ...
        CircularlySinglyLinkedList._insert_between(_Node(data), previous_node, current_node)
    ...
    def insert_first(self, data):
        ...
        """
        self.__length += 1
        CircularlySinglyLinkedList._insert_between(_Node(data), self.__head, self.__head.next_node)
    ...
    def remove_first(self):
        ...
        Traceback (most recent call last):
        ...
        circularly_singly_linked_list.Empty: List is empty
        >>> l_list.append(0)
        >>> l_list.append(1)
        >>> l_list.remove_first()
        >>> l_list
        ...
        CircularlySinglyLinkedList._remove_between(self.__head, current_node.next_node)
    ...
    def remove_last(self):
        ...
        while True:
            if isinstance(current_node.next_node, _SentinelNode):
                break
            previous_node = current_node
            current_node = current_node.next_node
    ...
    def get_last(self):
        ...
        while not isinstance(current_node.next_node, _SentinelNode):
            current_node = current_node.next_node
