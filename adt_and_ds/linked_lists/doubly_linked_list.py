...
class DoublyLinkedList:
    ...
    def __iter__(self):
        """ Returns a doubly linked list iterable. Time complexity: O(1).
    ...
    def __next__(self):
        """ Returns next item of doubly linked list iterator. Time complexity: O(1).
    ...
    def __delitem__(self, idx: int):
        ...
        DoublyLinkedList._remove_between(previous_node, current_node.next_node)
    ...
    def _insert_between(new_node: _BaseNode, node1: _BaseNode, node2: _BaseNode):
        ...
        False
        >>> DoublyLinkedList._insert_between(_Node(2), node_1, node_2)
        >>> isinstance(node_1.next_node.next_node, _Node)
        True
        """
    ...
    def _remove_between(node1: _BaseNode, node2: _BaseNode):
        ...
        >>> isinstance(node_1.next_node.next_node, _Node)
        True
        >>> DoublyLinkedList._remove_between(node_1, node_3)
        >>> isinstance(node_1.next_node.next_node, _Node)
        False
        """
    ...
    def insert(self, idx: int, data):
        ...
        DoublyLinkedList._insert_between(_Node(data), previous_node, current_node)
    ...
    def insert_first(self, data):
        ...
        """
        self.__length += 1
        DoublyLinkedList._insert_between(_Node(data), self.__head, self.__head.next_node)
    ...
    def insert_last(self, data):
        ...
        """
        self.__length += 1
        DoublyLinkedList._insert_between(_Node(data), self.__tail.previous_node, self.__tail)
    ...
    def remove_first(self):
        ...
        Traceback (most recent call last):
        ...
        doubly_linked_list.Empty: List is empty
        >>> l_list.append(0)
        >>> l_list.append(1)
        >>> l_list.remove_first()
        >>> l_list
        ...
        DoublyLinkedList._remove_between(self.__head, current_node.next_node)
    ...
    def remove_last(self):
        ...
        DoublyLinkedList._remove_between(previous_node, self.__tail)
