...
class SinglyLinkedList:
    ...
    def __iter__(self):
        """ Returns a singly linked list iterable. Time complexity: O(1).
    ...
    def __next__(self):
        """ Returns next item of singly linked list iterator. Time complexity: O(1).
    ...
    def _insert_between(new_node: _BaseNode, node1: _BaseNode, node2: _BaseNode):
        ...
        False
        >>> SinglyLinkedList._insert_between(_Node(2), node_1, node_1.next_node)
        >>> isinstance(node_1.next_node.next_node, _Node)
        True
        """
    ...
    def _remove_between(node1: _BaseNode, node2: _BaseNode):
        ...
        >>> isinstance(node_1.next_node.next_node, _Node)
        True
        >>> SinglyLinkedList._remove_between(node_1, node_1.next_node.next_node)
        >>> isinstance(node_1.next_node.next_node, _Node)
        False
        """
    ...
    def insert(self, idx: int, data):
        ...
        SinglyLinkedList._insert_between(_Node(data), previous_node, current_node)
    ...
    def insert_first(self, data):
        ...
        """
        self.__length += 1
        SinglyLinkedList._insert_between(_Node(data), self.__head, self.__head.next_node)
    ...
    def remove_first(self):
        ...
        Traceback (most recent call last):
        ...
        singly_linked_list.Empty: List is empty
        >>> l_list.append(0)
        >>> l_list.append(1)
        >>> l_list.remove_first()
        >>> l_list
        ...
        SinglyLinkedList._remove_between(self.__head, current_node.next_node)
